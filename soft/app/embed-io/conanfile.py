...
class AversivePlusPlusProjectConan(ConanFile):
    ...
    requires = (
        "AversivePlusPlus/0.1@AversivePlusPlus/dev",
        "toolchain-switch/0.1@AversivePlusPlus/dev",
        "hal-switch/0.1@AversivePlusPlus/dev",
        "stream-hal/0.1@AversivePlusPlus/dev",
        "device-hal/0.1@AversivePlusPlus/dev",

        "buggybot-protocol/0.1@AversivePlusPlus/dev",
        "device-buggybot-adm2560/0.1@AversivePlusPlus/dev",
        )
