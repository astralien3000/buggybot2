#ifndef IK_ROBOT_ARMATURE_JOINT_FOREARM_RB_ENDPOINT_HPP
#define IK_ROBOT_ARMATURE_JOINT_FOREARM_RB_ENDPOINT_HPP

#include "trigo.hpp"

namespace robot_armature_joint_forearm_rb_endpoint {
...
#endif//IK_ROBOT_ARMATURE_JOINT_FOREARM_RB_ENDPOINT_HPP
